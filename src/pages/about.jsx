...
const Abt = () => {
  return (
    <>
      <NextSeo
        title=" Haulage Services in Nigeria: Choose First Line Logistics Nigeria Limited"
        description="Need reliable and efficient haulage services in Nigeria? Look no further than First Line Logistics Nigeria Limited. Our experienced team has the expertise and equipment to handle all your transportation needs, from bulk cargo to individual packages. With a commitment to quality and customer service, we ensure your goods are delivered on time and in perfect condition. Contact us today to learn more about our haulage services in Nigeria."
        openGraph={{
      ...
      <main>
        ...
        <div className="w-full mx-auto text-center py-12 max-w-4xl">
          ...
          <div className="mb-10">
            <h3 className="font-bold mb-5 text-3xl font-body">
              Our Objectives
            </h3>
            <p className="text-xl">
            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-8 md:gap-12 xl:gap-16">
              ...
              <div className="flex flex-col justify-center items-center text-center gap-4 md:gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-800 mb-2">
                    We beleive time is essential, we have it as a point of duty
                    to ensure all items are delivered in short time
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center items-center text-center gap-4 md:gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-800 mb-2">
                    We believe in building a strong relationship beyond the
                    items being shipped, but rather share a mutual respect for
